...
export function MobileTopbar({ profile, onMenuOpen }: MobileTopbarProps) {
  return (
    <header className="sticky top-0 z-20 flex md:landscape:hidden lg:hidden h-16 w-full items-center justify-between border-b border-border bg-background px-4">
